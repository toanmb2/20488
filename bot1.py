...
def getNumberFromRGB(rgb):
    ...
    if(distance(rgb,(251, 250, 249)) <= 5):
        return 0
    elif(distance(rgb,(151, 224, 255)) <= 5):
        return 2
    elif(distance(rgb,(140, 208, 255)) <= 5):
        return 4
    elif(distance(rgb,(129, 191, 255)) <= 5):
        return 8
    elif(distance(rgb,(117, 175, 255)) <= 5):
        return 16
    elif(distance(rgb,(106, 158, 255)) <= 5):
        return 32
    elif(distance(rgb,(95, 142, 255)) <= 5):
        return 64
    elif(distance(rgb,(84, 126, 255)) <= 5):
        return 128
    elif(distance(rgb,(73, 109, 255)) <= 5):
        return 256
    elif(distance(rgb,(61, 93, 255)) <= 5):
        return 512
    elif(distance(rgb,(50, 76, 255)) <= 3):
        return 1024
    elif(distance(rgb,(39, 60, 255)) <= 5):
        return 2048
    elif(distance(rgb,(0, 26, 255)) <= 5):
        return 4096
    else:
        return -1
